  ...
  "nodes": {
    ...
    "common-09": {
      ...
      "steps": [
        ...
        {
          "text": "那天我是這樣過的：清早陪雁回送名，午後泡在鐘樓，傍晚拿一格換茶室一句話，天黑前順路回死信局還一封信。清早那一格，我留到最後再講——因為壓在心上的，是它。"
        },
        {
          "bg": "backgrounds/bell-tower.png",
          "fx": "fade"
        ...
        {
          "text": "午後，一格用在鐘樓。議會來人丈量，聽鐘一下午拿我當學徒使喚：搬、扶、遞。我沒問她一句關於三百刻年的事。"
        },
        {
        ...
        {
          "text": "傍晚，一格換進刻漏茶室——城裡人說，這家的老闆娘肯拿你一格時辰，換一句實話。我掏了一格，她開口。"
        },
        {
          "say": "坐。時辰是你的，茶是我的。",
          "who": "chashi"
        ...
        {
          "text": "天黑前順路，我把口袋裡那封錯拿的信還回死信局，交到她手上。她的頭髮比上一窗長了些，過了肩。"
        },
        {
          "set": {
    ...
    "ting-05": {
      ...
      "steps": [
        ...
        {
          "text": "修錶單自己翻了一頁，補記上一筆舊帳，日期正是傳習那天。原來她問「你剩幾窗」的那一刻，就已經在替我把後面每一格窗算好、省好——這份心意當時我沒看懂，此刻才結清成帳上的一筆。"
        },
        {
          "text": "趕門。出窗。"
        },
    ...
    "true-02": {
      ...
      "steps": [
        ...
        {
          "text": "到這裡我才想通：掌心這顆鑰，就是大鐘缺的齒輪；裝回去，大鐘才停得成那一拍。日記頁也寫明了——停拍時全城凍住，唯一還能動的是脫了刻的雁回，由她上塔補掛亥時槌。"
        },
        {
