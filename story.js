  ...
  "nodes": {
    "common-01": {
      ...
      "steps": [
        ...
        {
          "say": "阿律喔，食飽未？湯我囥佇電鍋，家己提去食。天欲寒矣，衫加穿一領。門若鎖好，較早睏。",
          "who": "amah"
        },
        {
        ...
        {
          "text": "收阿公的工具時，機芯裡多出一顆齒輪。黃銅的，對不上任何一張圖。"
        },
        {
    ...
    "common-04": {
      ...
      "steps": [
        ...
        {
          "text": "灶跤。阿嬤坐在竹椅上，剝著手裡的東西。她沒有問我去了哪裡。"
        },
        {
          "say": "食飽未？",
          "who": "amah"
    ...
    "common-05": {
      ...
      "steps": [
        ...
        {
          "text": "他領我進鐘樓內。角落有一張工作凳，看起來很舊，卻擦得乾淨。"
        },
        {
          "say": "凳子別坐。那是有主的。",
          "who": "zhongjiang"
        ...
        {
          "text": "我站在那張沒人坐的凳子前。欠的是什麼？為何五十年沒還？阿公說的「共我修予好」——到底是哪口鐘？"
        },
        {
          "hide": "ting"
        }
    ...
    "common-08": {
      ...
      "steps": [
        ...
        {
          "text": "回台灣，第一件事還是開電鍋。這次湯是好的。我吃了。"
        },
        {
          "text": "又過了兩個月——在這邊，只是兩天。"
        },
        {
          "text": "阿嬤在灶跤忙。爐火她忘了關，鍋燒乾了，冒煙。我趕過去掀開窗。"
        },
        {
          "text": "只是一場小小的險。沒別的意思。"
        },
    ...
    "common-09": {
      ...
      "steps": [
        ...
        {
          "text": "那天真正壓在我心上的，是清早那一格——我陪雁回送了一段名。"
        },
        {
    ...
    "end-common-normal": {
      ...
      "steps": [
        ...
        {
          "text": "台灣，店裡。我的修錶單一疊，交期欄全空著。客人來取，我總說：閣看覓。"
        },
        {
    ...
    "ting-01": {
      ...
      "steps": [
        ...
        {
          "text": "鐘樓底。她已經在塔下——不迎、不問，只把巡鐘名冊多捲了一份，攏在手裡。"
        },
        {
          "bg": "backgrounds/ke-city-market.png",
          "fx": "fade"
        ...
        {
          "text": "第一座、第二座。她上油、聽音、對時。她做，不教；我看，不問。這是「順路」的邊界。"
        },
        {
    ...
    "ting-02-out": {
      ...
      "steps": [
        ...
        {
          "text": "台灣。日曆翻過六頁，什麼事也沒發生——對我是六天，對她是明天一早。"
        }
      ],
      "next": "ting-03"
    },
    ...
    "ting-03-out": {
      ...
      "steps": [
        ...
        {
          "text": "台灣。電鍋是空的——巧合只製造麻煩。接著是住院，是出院，是姑姑接手了日常。"
        },
        {
          "sprite": {
            "char": "gu",
        ...
        {
          "say": "藥仔一工三擺，你若佇咧，就你提。對年欲按怎，你家己想。",
          "who": "gu"
        },
        {
          "say": "……閣看覓。",
    ...
    "ting-04": {
      ...
      "steps": [
        ...
        {
          "text": "後房。姑姑在。報日期時，出院的住院單據壓在日曆下，露出一角。我照上發條。不辯護，也不獨白。"
        },
        {
          "bg": "backgrounds/ke-city-market.png",
          "fx": "fade"
        ...
        {
          "text": "城裡多了一座並行的電鐘。她照常巡鐘——巡一座活的，經過一座不用巡的。"
        },
        {
    ...
    "man-04": {
      ...
      "steps": [
        ...
        {
          "text": "後房。報日期的聲音，比前五場都清楚——我學會認帳了。住院單據壓在桌角，一瞬入鏡。我報日期、置鑰、壓掌、上一圈。"
        },
        {
          "add": {
            "spring": -1
        ...
        {
          "text": "銷毀令貼在架前。她站在架與令之間。今天她扶著櫃沿站——髮半白了。我認出她的那半拍，慢了。"
        },
        {
          "sprite": {
            "char": "man",
    ...
    "man-05d": {
      ...
      "steps": [
        {
          "text": "對著步速歸零的她，阿公那句話在我腦裡響起，猶原是彼个原音——「錶行較慢無要緊，毋通予伊停去。」我沒有說出口。說這話的人，換了位置。"
        },
        {
    ...
    "yan-01": {
      ...
      "steps": [
        ...
        {
          "text": "五年來，我第一次把一個日子說得這麼完整——不是「閣看覓」，不是「好矣我叫你」，是初三。月曆上那格，我親手圈過。"
        },
        {
          "text": "阿嬤從灶跤探頭，把我看成另一個人：「添發，湯佇電鍋。」我沒有糾正她。有些認錯，糾正了反而更冷。"
        },
        {
          "bg": "backgrounds/tower-base-door.png",
          "fx": "fade"
    ...
    "yan-03": {
      ...
      "steps": [
        ...
        {
          "text": "後房。上發條。遞重物入鏡：對年倒數的紅字。報日期，比上一窗更清楚。"
        },
        {
        ...
        {
          "text": "晨。她對我比上一窗陌生了一格。我先報日期，把上次的事講給她聽——這一段，比 W4 長了一句。"
        },
        {
          "sprite": {
            "char": "yan",
    ...
    "yan-04": {
      ...
      "steps": [
        ...
        {
          "text": "台灣。W5 歸來，電鍋裡的湯沒動過——空鍋。阿嬤住院，出院，姑姑接手了日常。"
        },
        {
          "win": "W6",
          "price": "1 個月",
    ...
    "yan-06-eve": {
      ...
      "steps": [
        ...
        {
          "text": "台灣。阿嬤已經喚不出我的名，改喚「少年家」，每晚照樣留一碗湯。"
        },
        {
          "bg": "backgrounds/watch-shop-backroom-night.png",
          "fx": "fade"
    ...
    "true-02": {
      ...
      "steps": [
        ...
        {
          "text": "我對死鐘報日子的時候，阿公的話在腦內閃過一遍——「錶行較慢無要緊，毋通予伊停去。」"
        },
        {
          "text": "我沒有說出口。"
        },
    ...
    "true-04": {
      ...
      "steps": [
        ...
        {
          "text": "背蓋內側，一行字，一瞬——「錶行較慢無要緊，毋通予伊停去。」"
        },
        {
          "text": "沒有人說話。"
        }
